...
Next, install the optional dependency numba via pip (see [this link](https://pyautolens.readthedocs.io/en/latest/installation/numba.html) for a description of numba):
